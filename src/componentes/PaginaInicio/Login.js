            ...
            <div style={{ height: "450px", margin: "0px" }}>
                <div style={{ width: "300px", alignItems: "center", justifyContent: "center", margin: "auto" }}>
                    <form onSubmit={submit}>
                        <input type="text" name="usuario" placeholder="Usuario" onChange={manejadorChange} />
                        <input type="password" name="password" placeholder="Contraseña" onChange={manejadorChange} />
