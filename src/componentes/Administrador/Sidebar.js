  ...
  return (
    <div className="sidebar">
      <ul>
        ...
        <li>
          <NavLink className="text-blue rounded py-2 w-100 d-inline-block px-3" to="PanelAdministrador/Huespedes" exact="true" activeclassname="active"><HiIcons.HiUsers className="me-2"/>Huespedes</NavLink>
        </li>
      </ul>
    </div>
  );
