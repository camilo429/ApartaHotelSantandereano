...
// Componentes
import Acciones from "../PanelAseador/Acciones";
import ModuloActividad from "../PagesAseador/Actividades/ModuloActividad.js";
        ...
        <aside id="sidebar">
          <div className="h-100">
            <div className="sidebar-logo">
              <a href="hola.html">Aseador</a>
            </div>
            <ul className="sidebar-nav">
              <li className="sidebar-header">Elementos Aseador</li>
                ...
                <ul id="pages" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                  <li className="sidebar-item">
                    <NavLink className="sidebar-link" to="Actividades" exact="true" activeclassname="active">
                      <HiIcons.HiUsers className="me-2" />Tareas Asignadas
                    </NavLink>
                  </li>
                  {/*<li className="sidebar-item">
