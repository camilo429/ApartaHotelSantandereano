...
function Sales() {
    ...
    const peticionDelete = async () => {
        ...
        axios.request({
            ...
            if (response.status === 200) {
                setData(data.filter((consola) => consola.codProducto !== consolaSeleccionada.codProducto));
    ...
    const bodyEditar = (
        <div className={styles.modal}>
            ...
            <div align="right">
                <button color="primary" className="btn btn-primary" onClick={() => peticionPut()}>
                    Actualizar
                </button>
    ...
    const bodyEliminar = (
        <div className={styles.modal}>
            <p>
                Esta seguro de Eliminar el Producto<br />
                <b>
                    {
                        consolaSeleccionada &&
