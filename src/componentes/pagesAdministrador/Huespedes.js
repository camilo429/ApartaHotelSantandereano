...
function Huespedes() {
  ...
  const peticionGet = async () => {
    ...
    axios.request({
      ...
      setErrors({ message: "Error al obtener los huéspedes. Inténtalo de nuevo más tarde." });
    });
  };
    ...
    <div className={styles.modal}>
      ...
      <Form>
        <div className="flex">
          <FormGroup className="me-2">
            <Label for="exampleEmail">Nombre</Label>
            <input className="form-control" name="nombre" onChange={handleChange} value={consolaSeleccionada?.nombre} placeholder={!consolaSeleccionada?.nombre ? " su nombre" : "Nombre"} disabled />
          </FormGroup>
          <FormGroup className="me-2">
            <Label for="Apellido">Apellido</Label>
            <input className="form-control" name="apellido" onChange={handleChange} value={consolaSeleccionada && consolaSeleccionada.apellido} placeholder="Apellido" disabled />
          </FormGroup>
          <FormGroup className="me-2">
            <Label for="exampleEmail">Número Celular</Label>
            <input className="form-control" name="numCelular" onChange={handleChange} value={consolaSeleccionada && consolaSeleccionada.numCelular} placeholder="#Celular" disabled />
          </FormGroup>
        </div>
        <div className="flex">
          <FormGroup className="me-2">
            <Label for="email">Correo Electronico</Label>
            <input className="form-control" name="correo" onChange={handleChange} value={consolaSeleccionada && consolaSeleccionada.correo} placeholder="Correo Electronico" disabled />
          </FormGroup>
          ...
          <FormGroup className="me-2">
            <Label for="exampleEmail">Número Documento</Label>
            <input className="form-control" name="numDocumento" onChange={handleChange} value={consolaSeleccionada && consolaSeleccionada.numDocumento} disabled />
          </FormGroup>
          <FormGroup className="me-2">
            <Label for="exampleEmail">Nacionalidad</Label>
            <Nacionalidades name="nacionalidad" handleChangeData={handleChange} value={consolaSeleccionada.nacionalidad} />
          </FormGroup>
        </div>
        <div className="flex">
          <FormGroup className="me-2">
            <Label for="exampleEmail">¿Lugar de donde viene?</Label>
            <input className="form-control" name="lugarOrigen" onChange={handleChange} value={consolaSeleccionada && consolaSeleccionada.lugarOrigen} placeholder="lugarOrigen" disabled />
          </FormGroup>
          <FormGroup className="me-2">
            <Label for="exampleEmail">Nombre Emergencia</Label>
            <input className="form-control" name="nomContactoEmergencia" onChange={handleChange} value={consolaSeleccionada && consolaSeleccionada.nomContactoEmergencia} placeholder="Nombre Familiar" disabled />
          </FormGroup>
          <FormGroup className="me-2">
            <Label for="exampleEmail">#Contacto Emergencia</Label>
            <input className="form-control" name="numContactoEmergencia" onChange={handleChange} value={consolaSeleccionada && consolaSeleccionada.numContactoEmergencia} placeholder="# Contacto Emergencia" disabled />
          </FormGroup>
        </div>
      </Form>
      <div align="right">
      ...
      <Form style={{ textAlign: "center" }}>
        ...
        <div className="flex">
          ...
          <FormGroup className="me-2" style={{ width: "200px", margin: "20px" }}>
            ...
            {errors.estadoHuesped && (<div style={estilos}><p>{errors.estadoHuesped}</p></div>
            )}
          </FormGroup>
        </div>
      </Form>
